...
starttime = UTCDateTime("2018 08 14")    

endtime = UTCDateTime("2018 09 04")
...
for event in cat:
    try:
        ...
        wz ="ARC PRV   HHZ CM 00 %s %s%s %s%s %s   300"%(\
        ...
        wn = wz.replace("HHZ", "HHN")
        we = wz.replace("HHZ", "HHE")
        #print w
